...
import * as Helpers$ReasonDateFns from "./Helpers.bs.js";
...
import * as ClosestIndexTo from "date-fns/fp/fp/closestIndexTo";
...
function closestIndexTo(param, param$1) {
  return Helpers$ReasonDateFns.curry2(partial_arg, param, param$1);
}

var partial_arg$1 = FormatWithOptions.default;

function formatWithOptions(param, param$1, param$2) {
  return Helpers$ReasonDateFns.curry3(partial_arg$1, param, param$1, param$2);
}

var partial_arg$2 = Format.default;

function format(param, param$1) {
  return Helpers$ReasonDateFns.curry2(partial_arg$2, param, param$1);
}

var partial_arg$3 = ClosestTo.default;

function closestTo(param, param$1) {
  return Helpers$ReasonDateFns.curry2(partial_arg$3, param, param$1);
}

var partial_arg$4 = CompareAsc.default;

function compareAsc(param, param$1) {
  return Helpers$ReasonDateFns.curry2(partial_arg$4, param, param$1);
}
